...
const topicContent: Record<string, TopicSeoContent> = {
  "living-world-taxonomy-and-hierarchy": { focus: ["Distinguish a rank from a named taxon.", "Read genus and specific epithet together.", "Test one-way implications in nested categories."], traps: ["A matching epithet alone does not identify the same species.", "Sharing a family does not require sharing a genus.", "Taxonomic ranks are not stages of individual development."] },
  "protein-structure-and-peptide-bonds": { focus: ["Count peptide bonds for each independent linear chain.", "Separate local folding from whole-chain architecture.", "Distinguish backbone cleavage from loss of native shape."], traps: ["Two helices do not prove there are two subunits.", "Denaturation need not hydrolyse peptide bonds.", "The same residue inventory can occur in different sequences."] },
  "decomposition-and-mineralisation": { focus: ["Separate fragmentation, transport and chemical transformation.", "Calculate proportional dry-mass loss before interpreting it.", "Evaluate moisture together with oxygen availability."], traps: ["Lost litter mass is not a direct measure of mineral nutrients.", "Humus remains an organic pool.", "Decomposition processes can overlap instead of following a fixed sequence."] },
"animal-kingdom": {"focus":["Separate organisation, symmetry, germ layers and coelom as independent criteria.","Use a diagnostic bundle to compare major animal phyla.","Distinguish notochord from vertebral column."],"traps":["Bilateral symmetry does not prove an animal is coelomate.","A vertebral column is not the definition of a notochord.","Multicellular does not automatically mean organ-system level."]},
"structural-organisation-in-animals": {"focus":["Track how cell, tissue, organ and organ system differ in composition.","Distinguish the four basic animal-tissue categories using function and structure.","Keep tissue classification separate from organ-level mechanisms."],"traps":["A tissue is not simply a smaller organ.","Tendon joins muscle to bone; ligament joins bone to bone.","Striated tissue is not automatically voluntary."]},
"biotechnology-principles-and-processes": {"focus":["Assign a separate job to cutting, joining, vector design, host entry and recovery.","Explain why a vector needs replication, selection and insertion features.","Place downstream processing after biological production."],"traps":["Sticky ends are DNA ends, not enzymes.","Selection does not prove every chosen cell has the intended insert.","DNA entry, cloning and expression are separate checkpoints."]},
