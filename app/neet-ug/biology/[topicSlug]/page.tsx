...
"animal-kingdom": {"src":"/images/biology/animal-kingdom-evidence-map-v1.webp","alt":"Three independent animal classification criteria compare cell layers, radial and bilateral symmetry, and mesoderm-lined body cavity.","caption":"An original evidence map. Cell layers, symmetry and body-cavity lining are separate observations; do not infer one automatically from another."},
"structural-organisation-in-animals": {"src":"/images/biology/structural-organisation-animal-hierarchy-v1.webp","alt":"A hierarchy runs from epithelial tissue through a digestive organ and system to an organism, showing increasing division of labour.","caption":"An original hierarchy map. An organ contains several tissues, and an organ system coordinates several organs; the figures are conceptual rather than anatomical detail."},
"biotechnology-principles-and-processes": {"src":"/images/biology/biotechnology-recombinant-dna-order-v1.webp","alt":"A recombinant-DNA concept map shows a plasmid and DNA fragment isolated, cut, ligated into a plasmid and introduced into a host cell.","caption":"An original concept route. Cutting creates defined DNA ends, ligation seals the recombinant molecule, and host entry is a later checkpoint."},
