...
export default function NeetBiologyPdfPage() {
  return <main className="page pdfLanding">
    ...
    <section className="splitContent"><div className="contentBand"><h2>Planned resource focus</h2><ul className="seoList"><li>Topic-based concept maps for Biology revision.</li><li>Common-confusion checklists to use alongside NCERT.</li><li>Short recall routines for a focused revision session.</li><li>Clear source and update information for every published resource.</li></ul></div><div className="contentBand"><h2>Join early access</h2><WaitlistForm /></div></section>
  </main>;
}
